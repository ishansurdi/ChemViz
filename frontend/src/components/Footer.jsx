/**
 * Footer Component
 * Displays developer information and educational disclaimer
 */
      ...
      <div className="container-custom py-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 text-sm text-slate">
            <CodeBracketIcon className="w-5 h-5 text-industrial-blue" />
            <span className="font-medium">Developed by Ishan Surdi</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="https://github.com/ishansurdi/ChemViz"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-sm text-slate hover:text-industrial-blue transition-colors"
            >
